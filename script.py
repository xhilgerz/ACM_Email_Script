...
def generate_script(professor,name):
    ...
    with open(file_path,'w') as outfile:
        ...
        script = f"Greetings!\n\tI hope the start of the semester has been treating you well. My name is Zander Brysch and I am the membership officer of the Association of Computer Machinery or ACM. If you haven't heard of ACM before we are a computer science organization that strives to help fellow students learn more about coding and programming through community, workshops, hackathons, and other events. With ACM's Open House coming soon, we wanted to see if we could send a representative of ACM to very briefly present what ACM is about and our upcoming events for the semester. If your interested please let us know, and confirm if we have all the correct classes below."
